 ...
 * 
 * This script populates the CountryProfile table from JSON files.
 * Run with: node Countries/seed_country_profiles.js
 * 
 * Options:
...
// System user ID for seeding (will try to find super admin or use placeholder)
