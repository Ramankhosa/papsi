...
export default function InsightGrid({ onCardHover }: InsightGridProps) {
  ...
  const cards = [
    ...
    },
    {
      ...
      icon: '💡',
      title: 'Idea Bank',
      value: ideaStats ? `+${ideaStats.userReservations || 0}` : '0',
      description: ideaStats ?
        `+${ideaStats.userReservations || 0} ideas reserved, ${ideaStats.publicIdeas || 0} available` :
        'Loading ideas...',
    ...
    },
    {
      ...
      description: latestNovelty ?
        `Last: "${latestNovelty.title.substring(0, 25)}..." - ${latestNovelty.patentCount} hits` :
